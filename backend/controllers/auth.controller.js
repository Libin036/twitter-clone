...
export const signUp = async (req, res) => {
    ...
    try {
        ...
        const { username, fullName, email, password } = req.body; //gives datas from frontend through req
        ...
        const existingUser = await User.findOne({ email }) //checking user exists or not
